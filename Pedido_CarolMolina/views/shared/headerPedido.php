  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="index.php?control=usuario&action=verLogin">Ingresar</a>
          <a class="dropdown-item" href="index.php?control=usuario&action=verRegistro">Registrar</a>
        </div>
      </li>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="index.php?control=cliente&action=insert">Crear</a>
        </div>
      </li>
