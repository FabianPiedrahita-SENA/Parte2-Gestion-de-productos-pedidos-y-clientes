...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2020 a las 04:36:03
...
-- Base de datos: `adsi`
--
CREATE DATABASE IF NOT EXISTS `adsi` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `adsi`;
...
--
CREATE DATABASE IF NOT EXISTS `consecionario` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `consecionario`;
...
CREATE TABLE `cliente` (
  ...
  `nidentificacion` int(20) NOT NULL,
...
INSERT INTO `cliente` (`codigo`, `nombre`, `nidentificacion`, `direccion`, `ciudad`, `telefono`) VALUES
(0, '76trew', 2, 'uytrew55', 'uytr4e', 8);
...
CREATE TABLE `revision` (
  `codigo` int(11) NOT NULL,
  `cambioFiltro` varchar(20) NOT NULL,
  `cambioAceite` varchar(20) NOT NULL,
  `cambioFrenos` varchar(20) NOT NULL,
...
('root', '[{\"db\":\"adsi\",\"table\":\"usuario\"},{\"db\":\"login\",\"table\":\"datos\"},{\"db\":\"usuarios\",\"table\":\"datos_usuarios\"},{\"db\":\"consecionario\",\"table\":\"cliente\"},{\"db\":\"restaurante\",\"table\":\"cliente\"},{\"db\":\"datos\",\"table\":\"users\"},{\"db\":\"consecionario\",\"table\":\"auto\"},{\"db\":\"base_datos\",\"table\":\"usuario\"},{\"db\":\"restaurante\",\"table\":\"domiciliario\"},{\"db\":\"restaurante\",\"table\":\"pedido\"}]');
...
('root', '2020-11-08 03:34:11', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
